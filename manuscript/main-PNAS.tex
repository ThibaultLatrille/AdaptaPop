...
\matmethods{
       ...
       In \textit{Bayescode}, site-specific $\omega^{(i)}$ (fig.~\ref{fig:scatterplot}B, y-axis) as independent and identically distributed random effects from a gamma distribution\cite{lartillot_phylobayes_2013}.
       ...
       Both $\omega$ estimates from \textit{BayesCode} and \textit{CODEML} are strongly correlated at the site level ($r^2=0.985$, slope of $0.92$ in fig.~S1) and the gene level ($r^2=0.991$, slope of $0.9$ in fig.~S2).
