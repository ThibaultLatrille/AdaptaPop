...
\keywords{Adaptation $|$ phylogenetic $|$ population genetics $|$ codon models}
...
\begin{abstract}
       ...
       Importantly, mutation-selection codon models are based on a population-genetic formalism and thus are directly comparable to McDonald \& Kreitman test at the population level to quantify adaptation.
...
\dropcap{P}resent-day genetic sequences are informative of populations' past evolutionary history and can carry signatures of selection at different scales.
...
\matmethods{
       ...
       Classical codon models estimate a parameter $\omega=\dnds$, namely the ratio of the non-synonymous over the synonymous substitution rates\cite{muse_likelihood_1994,goldman_codonbased_1994}.
       ...
       Therefore, this corresponds to a continuous version of the M5 model of Yang \textit{et al}\cite{yang_codonsubstitution_2000}.
