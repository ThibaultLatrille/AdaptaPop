...
%TC:ignore
    ...
    This study stands at the crossroad between the phylogenetic and population-genetic tests of adaptation and highlights their respective limitations.
    On the one hand, the phylogeny-based method is computationally intensive;
    it requires well-resolved trees;
    it is crucially dependent on the quality of alignments;
    and can be gravely mis-led by paralogs erroneously identified as orthologs.
    ...
    \begin{table*}[!ht]
        ...
        \begin{adjustbox}{width = 1\textwidth}
            ...
            \begin{tabular}{|l|r|r|r|r|r|}
                ...
                integral component of membrane                    & 149 & 78.4  & 1.901 & 1.4$\times 10^{-8}$  & 1.1$\times 10^{-5}$$\bm{^*}$  \\
                defense response to virus                         & 15  & 1.795 & 8.355 & 1.7$\times 10^{-8}$  & 1.3$\times 10^{-5}$$\bm{^*}$  \\
                complement activation                             & 8   & 0.182 & 43.9  & 1.8$\times 10^{-8}$  & 1.4$\times 10^{-5}$$\bm{^*}$  \\
                integral component of plasma membrane             & 58  & 23.0  & 2.516 & 2$\times 10^{-8}$    & 1.5$\times 10^{-5}$$\bm{^*}$  \\
                leukocyte migration                               & 16  & 2.210 & 7.239 & 2.8$\times 10^{-8}$  & 2.1$\times 10^{-5}$$\bm{^*}$  \\
                neutrophil degranulation                          & 28  & 7.432 & 3.767 & 6$\times 10^{-8}$    & 4.5$\times 10^{-5}$$\bm{^*}$  \\
                external side of plasma membrane                  & 18  & 3.156 & 5.703 & 7.6$\times 10^{-8}$  & 5.7$\times 10^{-5}$$\bm{^*}$  \\
                plasma membrane                                   & 131 & 70.7  & 1.852 & 1.2$\times 10^{-7}$  & 9.1$\times 10^{-5}$$\bm{^*}$  \\
                lipid metabolic process                           & 31  & 9.452 & 3.280 & 1.9$\times 10^{-7}$  & 0.00014$\bm{^*}$              \\
                proteolysis                                       & 34  & 11.2  & 3.047 & 2.4$\times 10^{-7}$  & 0.00018$\bm{^*}$              \\
                platelet degranulation                            & 14  & 1.982 & 7.064 & 2.5$\times 10^{-7}$  & 0.00019$\bm{^*}$              \\
                cell surface                                      & 29  & 9.210 & 3.149 & 9.1$\times 10^{-7}$  & 0.00069$\bm{^*}$              \\
                extracellular vesicle                             & 10  & 0.969 & 10.3  & 9.5$\times 10^{-7}$  & 0.00072$\bm{^*}$              \\
                serine-type peptidase activity                    & 13  & 1.927 & 6.746 & 1$\times 10^{-6}$    & 0.00076$\bm{^*}$              \\
                toll-like receptor signaling pathway              & 9   & 0.729 & 12.4  & 1.1$\times 10^{-6}$  & 0.00086$\bm{^*}$              \\
                chemotaxis                                        & 13  & 1.988 & 6.540 & 1.3$\times 10^{-6}$  & 0.001$\bm{^*}$                \\
                defense response to bacterium                     & 12  & 1.690 & 7.100 & 1.7$\times 10^{-6}$  & 0.001$\bm{^*}$                \\
                adaptive immune response                          & 13  & 2.048 & 6.347 & 1.7$\times 10^{-6}$  & 0.001$\bm{^*}$                \\
                cilium movement                                   & 7   & 0.366 & 19.1  & 2.8$\times 10^{-6}$  & 0.002$\bm{^*}$                \\
                apical plasma membrane                            & 21  & 5.830 & 3.602 & 4.2$\times 10^{-6}$  & 0.003$\bm{^*}$                \\
                chemokine-mediated signaling pathway              & 7   & 0.488 & 14.3  & 9.5$\times 10^{-6}$  & 0.007$\bm{^*}$                \\
                cell surface receptor signaling pathway           & 18  & 4.787 & 3.760 & 1.2$\times 10^{-5}$  & 0.009$\bm{^*}$                \\
                cytolysis                                         & 5   & 0.123 & 40.8  & 1.3$\times 10^{-5}$  & 0.009$\bm{^*}$                \\
                antimicrobial humoral response                    & 5   & 0.123 & 40.8  & 1.3$\times 10^{-5}$  & 0.009$\bm{^*}$                \\
                positive regulation of heterotypic cell-cell a... & 5   & 0.123 & 40.8  & 1.3$\times 10^{-5}$ & 0.009$\bm{^*}$ \\
                hemostasis                                        & 9   & 1.094 & 8.225 & 1.3$\times 10^{-5}$  & 0.010$\bm{^*}$                \\
                cellular protein metabolic process                & 14  & 3.134 & 4.468 & 2$\times 10^{-5}$    & 0.015$\bm{^*}$                \\
                positive regulation of ERK1 and ERK2 cascade      & 14  & 3.194 & 4.383 & 2.5$\times 10^{-5}$  & 0.018$\bm{^*}$                \\
                platelet alpha granule                            & 5   & 0.184 & 27.2  & 3.2$\times 10^{-5}$  & 0.024$\bm{^*}$                \\
                dynein light chain binding                        & 5   & 0.184 & 27.2  & 3.2$\times 10^{-5}$  & 0.024$\bm{^*}$                \\
                lysosome                                          & 21  & 7.167 & 2.930 & 6.1$\times 10^{-5}$  & 0.045$\bm{^*}$                \\
        ...
        \caption{
            ...
            $775$ ontology Fisher's exact test are performed with $347$ genes detected as under adaptation and $5578$ genes as control for which ontologies are available.
    ...
    \begin{figure*}[!ht]
        ...
        \caption{
            ...
            The result is compared to the empirical null distribution of $\omega_{\mathrm{A}}$ in each population, obtained by randomly sampling (1000 replicates) a subset under a nearly-neutral regime.
        }
        \label{fig:method}
    \end{figure*}
    ...
    \begin{figure*}[!ht]
        ...
        \caption{
            ...
            For each population, $\omega_{\mathrm{A}}$ is computed on $822$ genes (A) and $104,129$ sites (B and C) having a high rate of adaptation at the phylogenetic scale (in red).
            In panel C, the set of sites are detected exclusively by mutation-selection codon models with a mean $\omega < 1 $.
            ...
            The acronym of populations, and the quantitative value of $\omega_{\mathrm{A}}$ and $p_{\mathrm{v}}$ are shown in table~\ref{table:unfolded-MK}}
    ...
    \begin{table*}[!ht]
        ...
        \begin{adjustbox}{width = 1\textwidth}
            \begin{tabular}{||l|l||r|r|r|r||r|r|r|r||r|r|r|r||}
                ...
                \multicolumn{4}{c||}{\textbf{Sites}} &
                \multicolumn{4}{c||}{\textbf{Sites exclusive to Mutation-Selection}}
                \\ \hline
                \textbf{Population} &
                \textbf{Species} & 
                \specialcell{$\bm{\omega_{\mathrm{A}}}$ \\ Adaptive} &
                \specialcell{$\bm{\left< \omega_{\mathrm{A}} \right>}$ \\ Control} &
                $\bm{p_{\mathrm{v}}^{\mathrm{adj}}}$    &
                ...
                $\bm{\frac{\Delta\omega_{\mathrm{A}}}{\Delta\omega_{\mathrm{A}}^{\mathrm{phy}}}}$
                \\                \midrule
                Diverse (Equus)                                     & Equus caballus      & 0.079 & -0.014  & \textbf{0.0}$\bm{^*}$   & 0.928 & 0.364  & -0.035 & \textbf{0.0}$\bm{^*}$ & 0.459 & 0.213 & -0.045 & \textbf{0.0}$\bm{^*}$ & 0.446 \\
                \rowcolor{LIGHTGREY}  Diverse (Canis)                 & Canis familiaris    & 0.059 & 0.00038 & \textbf{0.0}$\bm{^*}$   & 0.557 & 0.388  & -0.018  & \textbf{0.0}$\bm{^*}$ & 0.463 & 0.208 & -0.019 & \textbf{0.0}$\bm{^*}$ & 0.392 \\
                Iran (IRBT)                                         & Bos taurus          & 0.097 & 0.068   & \textbf{0.020}$\bm{^*}$ & 0.278 & 0.311  & 0.074  & \textbf{0.0}$\bm{^*}$ & 0.272 & 0.210 & 0.076 & 0.150~~ & 0.231 \\
