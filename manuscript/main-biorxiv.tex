...
\begin{figure*}[h!]
	...
	\caption{
		Enrichment of adaptation at the population-genetic scale for $29$ populations across $7$ genus at the gene (panel A) and site (panel B) level.
		...
		The result is compared to the empirical null distribution of $\omega_{\mathrm{A}}$, obtained by randomly sampling (1000 replicates) a subset of genes and sites under a nearly-neutral regime (violinplot in green).
