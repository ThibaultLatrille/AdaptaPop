...
\begin{figure*}[h]
	...
	\begin{minipage}{0.49\linewidth}
		\includegraphics[width=\linewidth, page=1]{Chlorocebus_sabaeus/gene-folded-grapes/Saint_Kitts-histogram.pdf}
	\end{minipage}
	\llap{\raisebox{-1.0cm}{\scriptsize A\hspace{0.35cm}}}\hfill
	\begin{minipage}{0.49\linewidth}
		\includegraphics[width=\linewidth, page=1]{Chlorocebus_sabaeus/site-folded-grapes/Saint_Kitts-histogram.pdf}
	\end{minipage}
	\llap{\raisebox{-1.0cm}{\scriptsize B\hspace{0.35cm}}}\hfill
...
\begin{figure*}[h]
	\centering
	\includegraphics[width=\linewidth, page=1]{results.pval.colors.pdf}
...
%\begin{figure*}[hb!]
%	\centering
%	\includegraphics[width=\textwidth]{artworks/codon_model.pdf}
